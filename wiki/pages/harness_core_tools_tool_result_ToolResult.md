---
name: "harness_core.tools.tool_result.ToolResult"
description: "Structured result from a tool call."
source: "harness_core/tools/tool_result.py"
---
...
## References
- [Module: harness_core.tools.tool_result](harness_core_tools_tool_result) - Parent module
- `llm_text`: str
- `display_text`: str
- `type_tag`: str - text
- `title`: str
