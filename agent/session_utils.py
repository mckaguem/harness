"""Session utilities — export, import, and display session data."""
            ...
            if role == "system":
                ...
                if doc.get("tool_calls"):
                    ...
                    for tc in doc["tool_calls"]:
                        func = tc.get("function", {})
                        # Convert arguments from string back to a JSON-like representation.
                        args_val = func.get("arguments", "")
                        if isinstance(args_val, str):
                            try:
...
def create_session_filename(agent_type_name: str = "main", extension: str = ".yaml") -> str:
    ...
    # Use fractional seconds with high precision to ensure uniqueness.
